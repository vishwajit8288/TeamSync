...
const SalaryVoucher = () => {
    ...
    //edit
    const onEdit = (item) => {
        setVoucherObj(prevObj => ({
            ...prevObj, salaryId: item.salaryId,
                        ...
                        <div className='card'>
                            ...
                            <div className='card-body'>
                                ...
                                <div className='row pt-3'>
                                    ...
                                    <div className='col-6'>
                                       {voucherObj.salaryId == 0 && <button className='btn btn-success' onClick={addSalary}>Save Salary</button>}
                                       {voucherObj.salaryId !== 0 &&<button className='btn btn-warning' onClick={updateSalaryVoucher}>Update</button>}
